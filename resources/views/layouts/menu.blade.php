        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="list-group">
                    ...
                    <a href="{{ route('distributors.index') }}" class="list-group-item list-group-item-action {{ Request::segment(1)=='distributors' ? 'active' : '' }}"><i class="fa fa-group"></i> Distributor</a>
